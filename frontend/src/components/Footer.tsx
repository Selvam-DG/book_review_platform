        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="text-gray-400 text-sm space-y-2">
              <li className="hover:text-white cursor-pointer transition" onClick={() => navigate("/books")}>
          ...
          <div>
            ...
            <button 
              ...
              className="w-full px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition text-sm font-medium" 
              >
              Submit Suggestion
            </button>
          </div>
